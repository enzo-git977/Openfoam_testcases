...
os.makedirs('data_eigen_Lean/', exist_ok=True) # dir where eigenvalues and vectors data are stored
...
np.savez_compressed(
    'data_eigen_Lean/eigen_data_Lean.npz',
...
print("Eigenvalues and vectors saved to data_eigen_Lean/eigen_data_Lean.npz")
