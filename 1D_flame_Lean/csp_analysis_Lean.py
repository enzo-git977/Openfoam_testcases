...
# === Paths ===============================================================================================================================
npz_path = 'data_eigen_Lean/eigen_data_Lean.npz'
...
# Get id of target_T1
idx_point = 3 # from 0 to 3 since they are 4 pts
...
for i, sp in enumerate(species):
    print(f"{sp:>4} | Cantera: {rad_pointers_max_ct[idx_point, i]:.4f} | OpenFOAM: {rad_pointers_max_of[idx_point, i]:.4f}")
