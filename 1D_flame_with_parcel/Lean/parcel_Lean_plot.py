...
time_folders_path = os.path.join(current_dir, "Openfoam_solution-lean-coarse", "postProcessing", "getEulerianFields") 
time = "0.04"
OF_path = os.path.join(current_dir, "Openfoam_solution-lean-coarse", "postProcessing", "axialLine", time, "line1.xy")
fig_dir = "figures_Lean"
...
# === Load Mechanism ==========================================================================================================
gas = csp.CanteraCSP('Openfoam_solution-lean-coarse/mech/hydrogen.yaml')
phi = 0.45 # lean
