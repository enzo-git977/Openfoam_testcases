...
# === Paths =========================================================================================================
filename = sys.argv[1]     # e.g., cuttingPlanes/0.037/zMid.vtk # vtk file path
time_name = sys.argv[2]    # e.g., "0.037"
npz_path = os.path.join("Eigen_data", time_name,'eigen_data.npz')
mech_dir = os.path.join(current_dir, 'csp-main','mech','mechanism.yaml')  # mech file path
output_dir = os.path.join('figures_vtk', time_name)
