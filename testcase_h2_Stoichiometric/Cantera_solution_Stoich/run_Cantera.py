...
sys.path.insert(0, '/home/maffeise/OpenFOAM/maffeise-12/run/testcase_h2_Stoichiometric/PyCSP') # make sure we're working with the fct in this directory
import PyCSP.Functions as csp

# === Output directories ===
os.makedirs('data_Stoichiometric/', exist_ok=True)
...
# === Save CSP arrays ===
np.savez_compressed(
    'data_Stoichiometric/csp_data.npz',
...
csv_path = 'data_Stoichiometric/cantera_states.csv'
